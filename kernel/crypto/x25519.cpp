...
// Compact implementation derived from TweetNaCl (public domain).
#include "x25519.h"
#include <string.h>
...
int x25519(uint8_t* q, const uint8_t* n, const uint8_t* p) {
    uint8_t z[32];
    i64 x[80], r, i;
    gf a, b, c, d, e, f;
...
int x25519_public_key(uint8_t* pub, const uint8_t* priv) {
